...
public class ImageController {
    ...
    public ResponseEntity<byte[]> getFile(@PathVariable String id) {
        ImageModel ImageModel = storageService.getFile((id));
    ...
    public ResponseEntity<ImageModel> deleteFile (@PathVariable String id){
        storageService.deleteFile(id);
        return new ResponseEntity<ImageModel>(HttpStatus.NO_CONTENT);
    }
